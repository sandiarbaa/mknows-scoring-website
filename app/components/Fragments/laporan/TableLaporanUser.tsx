...
const TableLaporanUser = ({ userData }: { userData: userDataProps[] }) => {
  ...
  const [checkboxListLaporan, setCheckboxListLaporan] =
  ...
  const handleCheckboxListLaporan = (): void => {
    setCheckboxListLaporan(!checkboxListLaporan);
  };
    ...
    <div className="bg-blue-500 overflow-x-auto">
      <table className="w-full text-xs bg-white table-auto text-start">
        <thead className="bg-[#F5F8FF] text-tulisan">
          <tr>
            <th className="p-2 text-end pr-10" colSpan={2}>
              No
            </th>
            <th className="w-1/4">
              NIK
                    ...
                    <table className="w-full text-xs bg-white table-auto text-start">
                      <thead className=" text-tulisan">
                        <tr className="px-20 text-ijoToska">
                          ...
                          <th className="bg-[#F5F8FF]">No. Permintaan</th>
                          <th className="bg-[#F5F8FF]">Tanggal Permintaan</th>
                          <th className="bg-[#F5F8FF]">Jenis Permintaan</th>
                          <th className="bg-[#F5F8FF]">Hasil</th>
                          <th className="bg-[#F5F8FF]">Lihat Detail</th>
                        ...
                        {expandedRowsData.map(
                          (
                            ...
                            <tr key={expandedIndex}>
                              ...
                              <td className="border-y">
                                <div className="py-1 bg-[#54B435] w-24 rounded font-semibold text-white text-center">
                                  Sangat Baik
                                </div>
                              </td>
                              <td className="text-center border-y">
                                <div className="bg-[#4AC1A2] w-16 mx-auto font-medium text-white py-1 rounded">
                                  Lihat
                                </div>
                              </td>
                              {/* <td className="text-center border-y">
                                <label htmlFor="checkboxLaporanUser">
                                  user
                                </label>
                                <input
                                  type="checkbox"
                                  name="checkboxLaporanUser"
                                  id="checkboxUser"
                                  checked={checkboxListLaporan}
                                />
                              </td> */}
